...
const EmployeeDashboardTaskList = () => {
  return (
    <div  id="EmployeeDashboardTaskList" className="h-[55%] overflow-auto flex items-center justify-start flex-nowrap gap-5 py-5 mt-10" >
     {/* Card1  */}
      ...
      <div className=" flex-shrink-0 h-full w-[300px] p-5 bg-blue-500 rounded-xl">
        ...
        <h2 className="mt-5 text-2xl  font-bold">Make a Fackbook Video</h2>
        <p className="text-sm mt-3"> Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi sed nam velit dolorem aut adipisci impedit temporibus esse ea placeat.</p>
      </div>
      {/* Card4  */}
      ...
      <div className=" flex-shrink-0 h-full w-[300px] p-5 bg-green-600 rounded-xl">
        ...
        <h2 className="mt-5 text-2xl  font-bold">Make a Facebook Video</h2>
        <p className="text-sm mt-3"> Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi sed nam velit dolorem aut adipisci impedit temporibus esse ea placeat.</p>
      </div>
      {/* Card9  */}
...
export default EmployeeDashboardTaskList;
